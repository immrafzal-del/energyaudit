    ...
    <div className="dashboard">
      ...
      <div className="charts-grid">
        <div className="chart-container oscilloscope-container">
          ...
          <DualOscilloscope voltageBuffer={vBuf} currentBuffer={iBuf}
            voltage={energyData.voltage} current={energyData.current} powerFactor={pfVal}/>
        </div>
      ...
      <div className="chart-container" style={{marginTop:20}}>
        ...
        <FFTOscilloscope voltageBuffer={vBuf} frequency={energyData.frequency||50}
          voltage={energyData.voltage} current={energyData.current}/>
      </div>
    </div>
  )
}
